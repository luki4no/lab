...
- [Bootloader - BIOS /tftpboot/pxelinux.cfg/default](#Bootloader-BIOS-/tftpboot/pxelinux.cfg/default)
- [Bootloader - EFI /tftpboot/efi/boot/grub.cfg](#Bootloader-EFI-/tftpboot/efi/boot/grub.cfg)
...
**Bootstrapping** bezeichnet die automatisierte Erstkonfiguration eines Systems nach dessen Bereitstellung. Es umfasst Aufgaben wie Softwareinstallation, Netzwerkkonfiguration und die Vorbereitung der Umgebung für den Einsatz oder weitere Automatisierung. Beispiele sind **Kickstart**, **Preseed**, **Cloud-Init** und **Ignition**.
