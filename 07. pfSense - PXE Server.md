...
**Custom DHCP Options** sind hauptsächlich für die Konfiguration von **Option 43 (Vendor-Specific Information)** und **Option 60 (Vendor Class Identifier)** gedacht. Diese erweiterten Optionen werden in komplexeren Umgebungen benötigt, beispielsweise zur Feinabstimmung von UEFI-Clients oder zur spezifischen Geräteerkennung. In Standard-PXE-Setups sind sie meist nicht erforderlich.
