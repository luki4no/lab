...
```powershell
ssh admin@192.168.100.2 "mkdir -p /usr/local/www/pxe/{iso,automation,centos,fedora,ubuntu,debian,kali} && chown -R root:www /usr/local/www/pxe && chmod -R 755 /usr/local/www/pxe"
```
