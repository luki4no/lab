...
Nano als Texteditor hinzufügen (alternativ vim benutzen):
```bash
...
[clients]
project-centos		ansible_host=192.168.100.10 ansible_user=lucian
project-ubuntus		ansible_host=192.168.100.11 ansible_user=lucian
project-fedora		ansible_host=192.168.100.12 ansible_user=lucian
project-debian		ansible_host=192.168.100.13 ansible_user=lucian
project-kali		ansible_host=192.168.100.14 ansible_user=lucian
```
