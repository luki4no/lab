...
$kaliIsoPath = "$isoDir\kali-linux-2024.3-installer-netinst-amd64.iso"
if (-Not (Test-Path $kaliIsoPath)) {
    $kaliIsoUrl = "https://cdimage.kali.org/kali-2024.3/kali-linux-2024.3-installer-netinst-amd64.iso"
