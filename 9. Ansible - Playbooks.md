...
```bash
sudo touch /etc/ansible/playbooks/sync-etc-hosts.yml
```
```bash
sudo nano /etc/ansible/playbooks/sync-etc-hosts.yml
```
```yml
---
...
```
```bash
ansible-playbook /etc/ansible/playbooks/sync-etc-hosts.yml --ask-become-pass
```
