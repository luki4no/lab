...
Jetzt kann kali nur mit der `eth1` aus dem Netz `192.168.200.0/24` die Partner-VMs vom Netz `192.168.100.0/24` erreichen.
...
SSH Session 2 (Ping funktioniert):
```bash
┌──(lucian㉿kali)-[~]
└─$ ping -c1 192.168.200.2
PING 192.168.200.2 (192.168.200.2) 56(84) bytes of data.
64 bytes from 192.168.200.2: icmp_seq=1 ttl=64 time=0.291 ms
