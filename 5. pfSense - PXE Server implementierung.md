...
Die Boot-Dateien sind auf der Centos DVD (unter D:\isolinux\) oder in dieser Repo vorhanden:
...
Danach vmlinuz und initrd.img von jeder ISO-Image des jeweiligen Betriebssystems importieren:

Wo sich diese befinden:

### 1. **CentOS**
- **Pfad für `vmlinuz`**: `images/pxeboot/vmlinuz`
- **Pfad für `initrd.img`**: `images/pxeboot/initrd.img`

### 2. **Debian**
- **Pfad für `vmlinuz`**: `install.amd/vmlinuz`
- **Pfad für `initrd.gz`**: `install.amd/initrd.gz`
...
### 5. **Ubuntu**
- **Pfad für `vmlinuz`**: `casper/vmlinuz`
- **Pfad für `initrd`**: `casper/initrd`
