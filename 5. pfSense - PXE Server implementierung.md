...
```
```powershell
PS C:\lab\vm\pxe> ssh admin@192.168.100.2 find /tftpboot -print
/tftpboot
...
PS C:\lab\vm\pxe> ssh admin@192.168.100.2 ls -lR /tftpboot/
total 46
...
```powershell
scp "D:\isolinux\ldlinux.c32" admin@192.168.100.2:/tftpboot/
scp "D:\isolinux\libcom32.c32" admin@192.168.100.2:/tftpboot/
scp "D:\isolinux\libutil.c32" admin@192.168.100.2:/tftpboot/
scp "D:\isolinux\vesamenu.c32" admin@192.168.100.2:/tftpboot/
```

# vmlinuz & initrd.img im TFTP Root Ordner /tftpboot/ transferieren
