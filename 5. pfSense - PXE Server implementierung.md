...
```
```powershell
PS C:\lab\vm\iso-images> ssh admin@192.168.100.2 find /tftpboot -print
/tftpboot
...
PS C:\lab\vm\iso-images> ssh admin@192.168.100.2 ls -lR /tftpboot/
total 1
drwxr-xr-x  3 root nobody 3 Nov  4 10:13 efi
drwxr-xr-x  2 root nobody 3 Nov  4 10:26 pxelinux.cfg
...
/tftpboot/pxelinux.cfg:
total 1
-rw-r--r--  1 root nobody 0 Nov  4 10:26 default
PS C:\lab\vm\iso-images>
```
