...
```
```powershell
scp "C:\lab\vm\iso-images\CentOS-Stream-9-latest-x86_64-dvd1" admin@192.168.100.2:/usr/local/www/pxe/centos
```
```powershell
scp "C:\lab\vm\iso-images\Fedora-Server-dvd-x86_64-41-1.4" admin@192.168.100.2:/usr/local/www/pxe/fedora
```
```powershell
scp "C:\lab\vm\iso-images\ubuntu-24.04.1-live-server-amd64" admin@192.168.100.2:/usr/local/www/pxe/ubuntu
```
```powershell
scp "C:\lab\vm\iso-images\debian-12.7.0-amd64-netinst" admin@192.168.100.2:/usr/local/www/pxe/debian
```
```powershell
scp "C:\lab\vm\iso-images\kali-linux-2024.3-installer-netinst-amd64" admin@192.168.100.2:/usr/local/www/pxe/kali
```
```powershell
