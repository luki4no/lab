...
- Software-Lösungen (Open-Source):
    ...
    - Intrusion Detection System (IDS): **Security Onion** (Linux)
...
- Ansible Playbooks für eine zentrale Konfigurationsverwaltung![image](https://github.com/user-attachments/assets/58fc494b-22a1-4ed4-b7cf-e2eadbfea25d)
