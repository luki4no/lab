...
> Mögliche "Play-Ziele" (lay targets) die auch in Playbooks vorkommen im Attribute 'hosts: ' sind:
>
> all = Alle VMs
> clients = Die Gruppe `[clients]` aus unserem Inventar `/etc/ansible/hosts`
