...
Falls die `docker-compose.yml` Datei schon mit `127.0.0.1:9392:80` gestartet wurde, einfach wie oben beschrieben anpassen (`sed` Kommando oder händisch editieren) und Container neu initialisieren:
