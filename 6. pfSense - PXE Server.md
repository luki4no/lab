...
LABEL centos
    ...
    APPEND ip=dhcp ks=http://192.168.100.2/tftpboot/centos/ks-centos.cfg
```
...
LABEL fedora
    ...
    APPEND ip=dhcp ks=http://192.168.100.2/tftpboot/fedora/ks-fedora.cfg

LABEL ubuntu
    MENU LABEL Ubuntu
    KERNEL ubuntu/vmlinuz
    INITRD ubuntu/initrd.img
    APPEND ip=dhcp ks=http://192.168.100.2/tftpboot/ubuntu/ks-ubuntu.cfg

LABEL debian
    MENU LABEL Debian
    KERNEL debian/vmlinuz
    INITRD debian/initrd.img
    APPEND ip=dhcp ks=http://192.168.100.2/tftpboot/debian/ks-debian.cfg

LABEL kali
    MENU LABEL Kali
    KERNEL kali/vmlinuz
    INITRD kali/initrd.img
    APPEND ip=dhcp ks=http://192.168.100.2/tftpboot/kali/ks-kali.cfg
```
---
