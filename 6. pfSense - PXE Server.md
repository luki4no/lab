...
Wir erstellen und bearbeiten deine PXE-Konfigurationsdatei (`/path/to/tftp/root/pxelinux.cfg/default`):

```powerhsell
PS > ssh admin@192.168.100.2

[2.7.2-RELEASE][admin@pfSense.home.arpa]/tftpboot: cd /tftpboot
[2.7.2-RELEASE][admin@pfSense.home.arpa]/tftpboot: ls -l
total 159358
-r--r--r--  1 root nobody 148747676 Oct 29 15:22 initrd.img
-r--r--r--  1 root nobody     38912 Oct 29 15:22 isolinux.bin
-r--r--r--  1 root nobody  14428200 Oct 29 15:22 vmlinuz
[2.7.2-RELEASE][admin@pfSense.home.arpa]/tftpboot: mkdir -p /tftpboot/pxelinux.cfg
[2.7.2-RELEASE][admin@pfSense.home.arpa]/tftpboot: ls -l
total 159358
-r--r--r--  1 root nobody 148747676 Oct 29 15:22 initrd.img
-r--r--r--  1 root nobody     38912 Oct 29 15:22 isolinux.bin
drwxr-xr-x  2 root nobody         2 Oct 29 15:37 pxelinux.cfg
-r--r--r--  1 root nobody  14428200 Oct 29 15:22 vmlinuz
[2.7.2-RELEASE][admin@pfSense.home.arpa]/tftpboot: cd pxelinux.cfg
[2.7.2-RELEASE][admin@pfSense.home.arpa]/tftpboot/pxelinux.cfg: touch /tftpboot/pxelinux.cfg/default
[2.7.2-RELEASE][admin@pfSense.home.arpa]/tftpboot/pxelinux.cfg: ls -l
total 1
-rw-r--r--  1 root nobody 0 Oct 29 15:38 default
[2.7.2-RELEASE][admin@pfSense.home.arpa]/tftpboot/pxelinux.cfg: vi /tftpboot/pxelinux.cfg/default
DEFAULT centos
LABEL centos
    KERNEL vmlinuz
    INITRD initrd.img
...
[2.7.2-RELEASE][admin@pfSense.home.arpa]/tftpboot/pxelinux.cfg: ls -l
total 1
-rw-r--r--  1 root nobody 89 Oct 29 15:38 default
[2.7.2-RELEASE][admin@pfSense.home.arpa]/tftpboot/pxelinux.cfg: cat default
DEFAULT centos
LABEL centos
    KERNEL vmlinuz
    INITRD initrd.img
