...
```
> Die '/tftpboot/pxelinux.cfg/default' ist unsere Hauptkonfigurationsdatei, in der wir alle anderen Betriebssysteme referenzieren werden. Jedes OS bekommt seine eigene Stanza mit den Adressen zu den jeweiligen Kernel-Images und Initial-RAM-Disk-Images.
