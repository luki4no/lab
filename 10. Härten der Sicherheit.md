...
- [System-Hardening-Techniken](#system-hardening-techniken)
...
- [Ausführen der Ansible Playbooks](#ausführen-der-ansible-playbooks)
...
```bash
ansible-playbook -i inventory_file /etc/ansible/playbooks/playbook.yml --ask-become-pass
```
