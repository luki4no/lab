      ...
      copy:
        ...
        content: |
          ...
          LABEL CentOS
            ...
            APPEND initrd=/var/nfs/iso/centos/initrd.img inst.repo=nfs:192.168.100.10:/var/nfs/iso/centos ks=nfs:192.168.100.10:/var/nfs/iso/automation/ks-centos.cfg

          LABEL Fedora
            KERNEL /var/nfs/iso/fedora/vmlinuz
            APPEND initrd=/var/nfs/iso/fedora/initrd.img inst.repo=nfs:192.168.100.10:/var/nfs/iso/fedora ks=nfs:192.168.100.10:/var/nfs/iso/automation/ks-fedora-gui.cfg

          LABEL Ubuntu
            KERNEL /var/nfs/iso/ubuntu/vmlinuz
            APPEND initrd=/var/nfs/iso/ubuntu/initrd.img autoinstall ds=nfs:192.168.100.10:/var/nfs/iso/automation/ai-ubuntu.yml

          LABEL Debian
            KERNEL /var/nfs/iso/debian/vmlinuz
            APPEND initrd=/var/nfs/iso/debian/initrd.img auto url=nfs:192.168.100.10:/var/nfs/iso/automation/ps-debian.cfg

          LABEL Kali
            KERNEL /var/nfs/iso/kali/vmlinuz
            APPEND initrd=/var/nfs/iso/kali/initrd.img auto url=nfs:192.168.100.10:/var/nfs/iso/automation/ps-kali-gui.cfg
      ...
      copy:
        ...
        content: |
          ...
          menuentry 'Install CentOS' {
            ...
            inst.repo=nfs:192.168.100.10:/var/nfs/iso/centos ks=nfs:192.168.100.10:/var/nfs/iso/automation/ks-centos.cfg
          }
          menuentry 'Install Fedora' {
            linuxefi /var/nfs/iso/fedora/vmlinuz
            initrdefi /var/nfs/iso/fedora/initrd.img
            inst.repo=nfs:192.168.100.10:/var/nfs/iso/fedora ks=nfs:192.168.100.10:/var/nfs/iso/automation/ks-fedora-gui.cfg
          }
...
PLAY RECAP ************************************************************************************************************************************************
localhost                  : ok=44   changed=43   unreachable=0    failed=0    skipped=1    rescued=0    ignored=0
