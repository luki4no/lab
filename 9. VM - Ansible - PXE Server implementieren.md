...
- hosts: localhost
  ...
  tasks:
    ...
    - name: Configure firewall for PXE-related services
      block:
        - name: Allow DHCP service through firewall
          command: firewall-cmd --permanent --add-service=dhcp

        - name: Allow TFTP service through firewall
        ...
        - name: Allow RPC Bind service through firewall
          command: firewall-cmd --permanent --add-service=rpc-bind

        - name: Allow Mountd service through firewall
...
TASK [Allow DHCP service through firewall] ********************************************************************************************
changed: [localhost]

TASK [Allow TFTP service through firewall] ********************************************************************************************
changed: [localhost]

TASK [Allow NFS service through firewall] *********************************************************************************************
changed: [localhost]

TASK [Allow RPC Bind service through firewall] ****************************************************************************************
changed: [localhost]

TASK [Allow Mountd service through firewall] ******************************************************************************************
changed: [localhost]

TASK [Reload firewall to apply changes] ***********************************************************************************************
changed: [localhost]
...
PLAY RECAP ****************************************************************************************************************************
localhost                  : ok=48   changed=47   unreachable=0    failed=0    skipped=1    rescued=0    ignored=0
