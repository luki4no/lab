...
> Die `template.env` werden wir im gleichen Ordner kopieren und zu `.env` umbenennen weil die Datei `~/misp-docker/.env` vom nächsten Kommando `docker compose pull` erwartet wird.
