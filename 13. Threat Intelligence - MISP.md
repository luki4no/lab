...
> Die `/template.env` werden wir im gleichen Ordner kopieren und zu `.env` umbenennen. Die Datei `~/misp-docker/.env` wird von nächsten Kommando `docker compose pull` erwartet
